...
$sql_first_table = "SELECT date, hoursSlept, quality FROM babysleeptracker WHERE user_id = ?";
    ...
    <div class="container">
        ...
        <div class="back-card">
            ...
            <?php while ($row = $result_first_table->fetch_assoc()) : ?>
                <tr>
                    <td><center><?php echo $row['hoursSlept']; ?></center></td>
